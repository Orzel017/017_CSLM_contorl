...
def build_welcome_page(self): # define build_welcome_page to setup the welcome UI elements
    ...
    self.application_welcome_widget.move(397, 64 - y_axis_offset_temp) # position the welcome widget
    ...
    self.welcome_title_widget.setFont(QFont("Amagro", 40)) # set font of welcome page title widget

    self.welcome_title_widget.move(359, 80 - y_axis_offset_temp) # position the title
    ...
    self.application_version_widget.move(401, 142 - y_axis_offset_temp) # position the version widget
    ...
    self.application_version_number_widget.move(456, 145 - y_axis_offset_temp) # position the version number widget
    ...
    self.developed_by_widget.move(360, 165 - y_axis_offset_temp) # position the developed by widget
